...
public class extra {
    ...
    /**
     * Rearranges order of digits in number to make it next by value
     * @param num random number
     * @return rearranged number
     */
    ...
    /**
     * Makes decimal number into 32-bit number and then represents it into IPv4 address
